...
impl Default for VotingContract {
  fn default() -> Self {
    Self {
        candidate_url: LookupMap::new(b"candidate_u".to_vec()),
        candidate_pair: LookupMap::new(b"candidate_p".to_vec()),
        prompt_array: UnorderedSet::new(b"prompt_array".to_vec()),
        vote_array: LookupMap::new(b"vote_array".to_vec()),
        user_participation: LookupMap::new(b"user_participation".to_vec()),
        test_collection:LookupMap::new(b"test_collection".to_vec()),
    }
  }
}
